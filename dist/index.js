...
const getTenantByName = (variables) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const body = yield response.json();
    errorCheck(body);
    console.log("aaaa: ", (_c = (_b = body === null || body === void 0 ? void 0 : body.data) === null || _b === void 0 ? void 0 : _b.getTenant) === null || _c === void 0 ? void 0 : _c.items);
    return ((_e = (_d = body === null || body === void 0 ? void 0 : body.data) === null || _d === void 0 ? void 0 : _d.getTenant) === null || _e === void 0 ? void 0 : _e.items[0]) || null;
});
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getTenantByTenantName = void 0;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const existingTenant = yield (0, appsyncQuery_1.getTenantByName)({ name: tenantName });
            ...
            if (!existingTenant) {
                ...
                yield (0, appsyncQuery_1.registerTenantQuery)({
                    tenantName,
                    name,
                    emailAddress,
                });
